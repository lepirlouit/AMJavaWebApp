...
- am-web-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- am-web-ui: main application module, development time
- am-web-production: module that produces a production mode WAR for deployment
